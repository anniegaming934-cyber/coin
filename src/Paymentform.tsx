...
export interface PaymentFormProps {
  ...
  onRecharge?: (payload: {
    ...
    note?: string;
    date?: string; // optional payment date
  }) => Promise<void> | void;
...
const PaymentForm: FC<PaymentFormProps> = ({
  ...
  const [showResetModal, setShowResetModal] = useState(false); // modal open/close
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setOk(`Added ${fmtUSD(amt)} via ${method} on ${date}.`);
  ...
  // 🟠 REAL reset logic (called from modal confirm)
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  This will clear all recorded payments and set Cash App,
                  PayPal, and Chime totals back to 0. This action cannot be
                  undone.
                </p>
              </div>
            </div>
